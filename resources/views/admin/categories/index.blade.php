...
@section('link_url')
    <div class="m-portlet__head-text text-right">
        <a href="{{ route('admin.categories.create') }}" class="btn btn-primary m-btn m-btn--custom m-btn--icon m-btn--air">
...
@section('search')
    ...
    {!! Form::open(['method' => 'GET', 'route' => ['admin.categories.index'], 'class' => 'm-form m-form--fit m-form--label-align-right']) !!}
    <div class="form-group m-form__group row align-items-center">
        ...
        <div class="col-md-4">
            ...
            <div class="m-form__control">
                {!! Form::select('menu', $menus, isset($search['menu']) ? $search['menu'] : null, ['placeholder' => __('custom.button.select-all'), 'class' => 'form-control m-input']) !!}
            </div>
        </div>
        <div class="col-md-4">
            <div class="m-form__label">
    ...
    <div class="col-xl-4 order-1 order-xl-2">
        ...
        <a href="{{ route('admin.categories.index') }}" class="btn btn-secondary m-btn m-btn--custom m-btn--icon m-btn--air">
    ...
    <table class="table m-table m-table--head-separator-primary">
        ...
        @foreach($data as $i => $item)
            <tr>
                ...
                <td>
                    @foreach(\App\Models\Datameta::getExistLanguages(['type' => \App\Models\Datameta::TYPE_CATEGORY, 'id' => $item->id, 'field' => 'name']) as $k => $language)
                        @php($lang = str_replace('name_', '', $language->data_field))
                        <a href="{{ route('admin.categories.edit', ['id' => $item->id, 'lang' => $lang]) }}">
                ...
                <td class="">
                    <a href="{{ route('admin.categories.edit', ['id' => $item->id]) }}" class="btn btn-accent m-btn m-btn--icon m-btn--air">

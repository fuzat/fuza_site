...
class JobType extends Model
{
    ...
    {
        return $this->hasMany(Datameta::class, 'data_id')->where('data_type', Datameta::TYPE_JOB_TYPE);
    }
    ...
    public function datameta($lang = '', $field = '')
    {
        ...
        return $this->hasOne(Datameta::class, 'data_id')
            ->where('data_type', Datameta::TYPE_JOB_TYPE)

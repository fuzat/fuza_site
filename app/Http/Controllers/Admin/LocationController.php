...
{
    private $_view = 'admin.locations.';
    private $_attr = Location::_ATTR;
    private $_model;

    public function __construct()
    {
        parent::__construct();
        $this->_model = new Location();
    }
    ...
    public function index(Request $request)
    {
        ...
        $page_setting = ['title' => __('datametas.title.location.index'), 'attr' => $this->_attr];
    ...
    {
        $page_setting = ['title' => __('datametas.title.location.create'), 'attr' => $this->_attr];
    ...
    public function edit($id)
    {
        ...
        $page_setting = ['title' => __('datametas.title.location.edit'), 'attr' => $this->_attr];
    ...
    public function destroy($id)
    {
        ...
        try {
            Datameta::removeRecord($data->id, Datameta::TYPE_LOCATION);
            $data->company_locations()->delete();
            $data->delete();

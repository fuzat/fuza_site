...
{
    private $_view = 'admin.global-presence.';
    private $_attr = GlobalPresence::_ATTR;
    private $_model;

    public function __construct()
    {
        parent::__construct();
        $this->_model = new GlobalPresence();
    }
    ...
    public function index(Request $request)
    {
        ...
        $page_setting = ['title' => __('datametas.title.global-presence.index'), 'attr' => $this->_attr];
    ...
    {
        $page_setting = ['title' => __('datametas.title.global-presence.create'), 'attr' => $this->_attr];
    ...
    public function edit($id)
    {
        ...
        $page_setting = ['title' => __('datametas.title.global-presence.edit'), 'attr' => $this->_attr];

        $vars = ['id', 'data', 'lang', 'page_setting'];

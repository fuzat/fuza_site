...
{
    private $_model = null;
    private $_attr = JobType::_ATTR;
    private $_view = 'admin.job-types.';

    public function __construct()
    {
        parent::__construct();
        $this->_model = new JobType();
    }
    ...
    public function index(Request $request)
    {
        ...
        $page_setting = ['title' => __('datametas.title.job-type.index'), 'attr' => $this->_attr];
    ...
    {
        $page_setting = ['title' => __('datametas.title.job-type.create'), 'attr' => $this->_attr];
    ...
    public function edit($id)
    {
        ...
        $page_setting = ['title' => __('datametas.title.job-type.edit'), 'attr' => $this->_attr];
    ...
    public function destroy($id)
    {
        ...
        try {
            $data->jobs()->update(['type_id' => null]);
        } catch (\Exception $exception) {
            return redirect()->route($this->_view . 'index')->with('fail', $exception->getMessage());
        }

        Datameta::removeRecord($data->id, Datameta::TYPE_JOB_TYPE);
        $data->delete();

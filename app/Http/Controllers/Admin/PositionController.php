...
{
    private $_view = 'admin.positions.';
    private $_attr = Position::_ATTR;
    private $_model;

    public function __construct()
    {
        parent::__construct();
        $this->_model = new Position();
    }
    ...
    public function index(Request $request)
    {
        ...
        $page_setting = ['title' => __('datametas.title.position.index'), 'attr' => $this->_attr];
    ...
    {
        $page_setting = ['title' => __('datametas.title.position.create'), 'attr' => $this->_attr];
    ...
    public function edit($id)
    {
        ...
        $page_setting = ['title' => __('datametas.title.position.edit'), 'attr' => $this->_attr];
    ...
    public function destroy($id)
    {
        ...
        try {
            $data->board_directors()->detach();
        } catch (\Exception $exception) {
            return redirect()->route($this->_view . 'index')->with('success', $exception->getMessage());
        }

        Datameta::removeRecord($data->id, Datameta::TYPE_POSITION);
        $data->delete();
